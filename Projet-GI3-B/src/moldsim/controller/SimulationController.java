...
public class SimulationController {
    ...
    private static final double BASE_SPORE_GERMINATION = 0.05; 
    private static final double SPORULATION_THRESHOLD = 10.0; 
    private static final int MIN_ACTIVE_MOLD_AGE_BEFORE_DEATH = 104; 
    private static final double BASE_MOLD_DEATH_PROBABILITY = 0.04; 
    private static final double CRITICAL_MOLD_LEVEL = 90.0; 
        ...
        for (Cell[] row : wall.getGrid()) {
            for (Cell cell : row) {
                ...
                if (random.nextDouble() < removalProbability) {
                    cell.cure(); // Micro-amélioration : utilisation de la méthode cure() intégrée
                }
            }
        }
    }
