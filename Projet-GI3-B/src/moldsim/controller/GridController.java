...
public class GridController {
        ...
        mainView.getSpeedSlider().valueProperty().addListener((obs, oldVal, newVal) -> {
            ...
            if (isRunning && simulationTimer != null) {
                ...
                simulationTimer.getKeyFrames().setAll(
                    new KeyFrame(Duration.seconds(delay), e -> step())
                );
    ...
    private void saveSimulation() {
        ...
        chooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Simulation files", "*.sim"));
        File file = chooser.showSaveDialog(mainView.getScene().getWindow());
        if (file != null) {
    ...
    private void loadSimulation() {
        ...
        chooser.getExtensionFilters().add(new FileChooser.ExtensionFilter("Simulation files", "*.sim"));
        File file = chooser.showOpenDialog(mainView.getScene().getWindow());
        if (file != null) {
